...
url = 'https://gfw-files.s3.amazonaws.com/ai4e/DRC_2012_2017_Risk.tif'
r = requests.get(url, stream=True)
chunk_size = 200000
with open(os.path.join(os.getcwd(),'DRC_2012_2017_Risk.tif'), 'wb') as fd:
...
def run_model(taskId, body):
    ...
    raster_file = os.path.join(os.getcwd(),'DRC_2012_2017_Risk.tif')
